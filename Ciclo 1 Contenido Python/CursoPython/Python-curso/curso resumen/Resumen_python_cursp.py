...
# from os import system  esto es una importacion y la utilizo para 
# limpiar la consola de la siguiente manera 
# system("cls")
...
# esto es para limpar la consola
system("cls")

# para inprimir un mensaje  se utiliza  print
print("=================/ Hello world /===================")



# str 
# Esttos son los tipos de datos hay de string, boleanos, enteros 
